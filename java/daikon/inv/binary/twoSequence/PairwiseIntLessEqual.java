...
public class PairwiseIntLessEqual extends TwoSequence {
  ...
  final String format_dsl(@GuardSatisfied PairwiseIntLessEqual this) {
  ...
  public Invariant merge(List<Invariant> invs, PptSlice parent_ppt) {
    ...
    PairwiseIntLessEqual result =
        (PairwiseIntLessEqual) super.merge(invs, parent_ppt);
    ...
    for (Invariant inv : invs) {
      PairwiseIntLessEqual pile = (PairwiseIntLessEqual) inv;

      result.a1ElementsMaxValue =
          Math.max(result.a1ElementsMaxValue, pile.a1ElementsMaxValue);

      result.a2ElementsMinValue =
          Math.min(result.a2ElementsMinValue, pile.a2ElementsMinValue);
    }
