...

{
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqIntGreaterEqual merge(
      @Prototype SeqSeqIntGreaterEqual this,
      List<@NonPrototype Invariant> invs,
      PptSlice parent_ppt) {

    SeqSeqIntGreaterEqual result =
        (SeqSeqIntGreaterEqual) super.merge(invs, parent_ppt);
    ...
    for (Invariant inv : invs) {
      SeqSeqIntGreaterEqual s = (SeqSeqIntGreaterEqual) inv;
