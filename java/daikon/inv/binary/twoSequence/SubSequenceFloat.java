...
public class SubSequenceFloat extends TwoSequenceFloat {
  ...
  public String  format_dsl(@GuardSatisfied SubSequenceFloat this) {
    return "isSubsequence(" + var1().name() + ", " + var2().name() + ")";
  }
  ...
  private String format_simplify_explicit(@GuardSatisfied SubSequenceFloat this) {
    ...
    // a is the subsequence.
    String aE;
    String aI;
    String aL;
    String aH;
    String aS;
    // b is the supersequence.
    String bE;
    String bI;
    String bL;
    String bH;
  ...
  public static @Nullable IPair<DiscardCode,String> isObviousSubSequence(VarInfo subvar, VarInfo supervar) {
    ...
    if (subvar_super == supervar_super) {
      ...
      if ((subvar.derived instanceof SequenceFloatSubsequence
        ...
        VarInfo sub_right_var = null;
        VarInfo super_left_var = null;
        VarInfo super_right_var = null;
        ...
        int sub_right_shift = 69;
        int super_left_shift = 1492;
        int super_right_shift = 1776;
        if (subvar.derived instanceof SequenceFloatSubsequence) {
        ...
        boolean left_included = false;
        boolean right_included = false;
...
;
  ...
  public @Nullable DiscardInfo isObviousStatically(VarInfo[] vis) {
    ...
    if (!subvar.aux.hasOrder()
      ...
      // Doesn't make sense to consider subsequence if order doesn't matter
      return new DiscardInfo(this, DiscardCode.obvious,
