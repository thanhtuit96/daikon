  ...
  public String format_using(@GuardSatisfied SeqSeqFloatEqual this, OutputFormat format) {
    ...
    if (format == OutputFormat.POSTMAN) {
      ...
      if (orderMatters) {
        ...
        return "pm.expect(" + array1 + ".every(element => " + array2 + ".includes(element)) && " + array2
            + ".every(element => " + array1 + ".includes(element))).to.be.true";
      }

    }
    if (format == OutputFormat.DSL) {
      if (orderMatters) {
        return "lexicalEQ(" + var1().name() + ", " + var2().name() + ")";
      } else {
        return "setEQ(" + var1().name() + ", " + var2().name() + ")";
      }
    }
