...

{
  ...
  public String format_using(@GuardSatisfied SeqSeqFloatLessEqual this, OutputFormat format) {
    ...
    if (format == OutputFormat.DSL) {
      return "isLexLTE(" + var1().name() + ", " + var2().name() + ")";
    }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqFloatLessEqual merge(
      @Prototype SeqSeqFloatLessEqual this,
      List<@NonPrototype Invariant> invs,
      PptSlice parent_ppt) {

    SeqSeqFloatLessEqual result =
        (SeqSeqFloatLessEqual) super.merge(invs, parent_ppt);
    ...
    for (Invariant inv : invs) {
      SeqSeqFloatLessEqual s = (SeqSeqFloatLessEqual) inv;
