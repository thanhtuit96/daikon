...

{
  ...
  public String format_using(@GuardSatisfied SeqSeqFloatGreaterThan this, OutputFormat format) {
    ...
    if (format == OutputFormat.DSL) {
      return "isLexGT(" + var1().name() + ", " + var2().name() + ")";
    }
  ...
  @Override
  public @Nullable @NonPrototype SeqSeqFloatGreaterThan merge(
      @Prototype SeqSeqFloatGreaterThan this,
      List<@NonPrototype Invariant> invs,
      PptSlice parent_ppt) {

    SeqSeqFloatGreaterThan result =
        (SeqSeqFloatGreaterThan) super.merge(invs, parent_ppt);

    if (result == null) {
      return null;
    }

    // Merge AGORA++ statistics
    for (Invariant inv : invs) {
      SeqSeqFloatGreaterThan s = (SeqSeqFloatGreaterThan) inv;
