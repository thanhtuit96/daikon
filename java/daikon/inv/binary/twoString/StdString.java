...
public abstract class StdString extends TwoString {
  ...
  public @Nullable DiscardInfo isObviousDynamically(VarInfo[] vis) {
    ...
    // antecedents in an array are true, then the invariant is obvious.
  ...
  /**
   * Returns a format string for the specified output format. Each instance of %varN% will be
  ...
  public static class SubString extends StdString {
    ...
    public String get_format_str(@GuardSatisfied SubString this, OutputFormat format) {
      if (format == OutputFormat.DAIKON) {
        ...
        return "isSubstring(" + var1().name() + ", " + var2().name() + ")";
      } else {
