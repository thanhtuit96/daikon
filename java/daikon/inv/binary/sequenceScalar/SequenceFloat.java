...
public abstract class SequenceFloat extends BinaryInvariant {
  ...
  /**
   * Returns true if the specified types are valid. All subclasses accept a scalar in one
 ...
 protected final boolean seq_first(@GuardSatisfied SequenceFloat this) {
  ...
  /**
   * Returns the sequence variable in the tuple whose VarInfos are corresponds to this.ppt.var_infos.
   */
  ...
  /**
   * Returns the scalar variable in the tuple whose VarInfos are corresponds to this.ppt.var_infos.
   */
