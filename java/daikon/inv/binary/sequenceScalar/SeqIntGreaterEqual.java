...
public final class SeqIntGreaterEqual extends SequenceScalar {
  ...
  public String format_dsl(@GuardSatisfied SeqIntGreaterEqual this) {
    return "gte(" + seqvar().name() + ", " + sclvar().name() + ")";
  }
  ...
  private static NISuppressionSet suppressions =
    new NISuppressionSet(
        ...
        @Override
  public @Nullable SeqIntGreaterEqual merge(
      List<Invariant> invs,
      PptSlice parent_ppt) {
    ...
    SeqIntGreaterEqual result = instantiate_dyn(parent_ppt);
