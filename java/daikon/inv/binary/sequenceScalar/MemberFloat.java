...
public final class MemberFloat extends SequenceFloat {
  ...
  /** Returns true if sclvar is a member of seqvar can be determined statically. */
  @Pure
  public static boolean isObviousMember(VarInfo sclvar, VarInfo seqvar) {
    ...
    if (seqvar.derived instanceof SequenceFloatSubsequence
      ...
      int seq_left_shift = 0;
      int seq_right_shift = 0;
      if (seqvar.derived instanceof SequenceFloatSubsequence) {
  ...
  public String format_dsl(@GuardSatisfied MemberFloat this) {
    return "forall(" + seqvar().name() + ", in(element, " + sclvar().name() + "))";
  }
