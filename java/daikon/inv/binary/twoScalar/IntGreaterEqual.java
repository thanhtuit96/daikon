...
public final class IntGreaterEqual extends TwoScalar {
  ...
  /** Returns true if the specified var types are valid for IntGreaterEqual. */
  @Override
  ...
  public String format_using(@GuardSatisfied IntGreaterEqual this, OutputFormat format) {
    ...
    if (format == OutputFormat.POSTMAN) {
      return "pm.expect(" + getPostmanVariableName(var1().name()) + ").to.be.at.least("
          + getPostmanVariableName(var2().name()) + ")";
    }
    if (format == OutputFormat.DSL) {
      return "gte(" + var1().name() + ", " + var2().name() + ")";
    }
  ...
  public Invariant merge(List<Invariant> invs, PptSlice parent_ppt) {
    ...
    IntGreaterEqual result = (IntGreaterEqual) super.merge(invs, parent_ppt);
    if (result == null) {
      return null;
    }
    ...
    for (Invariant inv : invs) {
      IntGreaterEqual other = (IntGreaterEqual) inv;
