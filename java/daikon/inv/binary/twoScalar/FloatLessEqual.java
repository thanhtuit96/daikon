...
public final class FloatLessEqual extends TwoFloat {
  ...
  /** Returns true if the specified var types are valid for FloatLessEqual. */
  @Override
  ...
  public Invariant merge(List<Invariant> invs, PptSlice parent_ppt) {
    ...
    FloatLessEqual result = (FloatLessEqual) super.merge(invs, parent_ppt);
    if (result == null) {
      return null;
    }
    ...
    for (Invariant inv : invs) {
      FloatLessEqual other = (FloatLessEqual) inv;
