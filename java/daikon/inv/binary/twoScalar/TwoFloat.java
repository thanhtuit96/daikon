 ...
 * all permutations and resurrection are handled here.
 *
...
public abstract class TwoFloat extends BinaryInvariant {
  ...
  /** Returns true if the variable order is currently swapped for this invariant. */
  @Override
  ...
  /**
   * Returns true if both invariants are the same class and the order of the variables (swap) is the
   * same.
   */
  @Pure
  @Override
