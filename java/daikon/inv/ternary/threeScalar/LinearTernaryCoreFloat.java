...
public final class LinearTernaryCoreFloat implements Serializable, Cloneable {
  ...
  /**
   * Returns true if the invariant is currently active. We become active after MINTRIPLES
   ...
   *
   * @param points array of points to use to calculate the coefficients. Only the first three points
  ...
  public double[] calc_tri_linear(@Nullable Point[] points) { // TODO: remove annotation after refactoring method
    ...
    // Ensure positive x coefficient by negating if "x" term is negative.
    if (i_var < 0) {
