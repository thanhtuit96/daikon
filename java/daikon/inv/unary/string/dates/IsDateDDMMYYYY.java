...
public class IsDateDDMMYYYY extends SingleString {
    ...
    public String format_using(@GuardSatisfied IsDateDDMMYYYY this, OutputFormat format) {
        if (format == OutputFormat.DAIKON) {
            return var().name() + " is a Date. Format: DD/MM/YYYY or DD-MM-YYYY or DD.MM.YYYY";
        }
    ...
    @Override
    public @Nullable @NonPrototype IsDateDDMMYYYY merge(
        @Prototype IsDateDDMMYYYY this,
        List<@NonPrototype Invariant> invs,
        PptSlice parent_ppt) {
        return (IsDateDDMMYYYY) super.merge(invs, parent_ppt);
    }
}
