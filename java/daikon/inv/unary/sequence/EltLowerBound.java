...
public class EltLowerBound extends SingleScalarSequence {
  ...
  public String format_using(@GuardSatisfied EltLowerBound this, OutputFormat format) {
    ...
    } else if (format == OutputFormat.DSL) {
      return format_dsl();
    }
  ...
  public String format_postman(@GuardSatisfied EltLowerBound this) {
    return "pm.expect(" + getPostmanVariableName(var().name()) + ".every(element => element >= " + core.min1
        + ")).to.be.true";
  }
  public String format_dsl(@GuardSatisfied EltLowerBound this) {
    return "every(" + var().name() + ", element => element >= " + core.min1 + ")";
  }
  // ELTLOWEr || ELTUPPEr
  ...
  public @Nullable DiscardInfo isObviousStatically(VarInfo[] vis) {
    ...
    if ((var.derived instanceof SequenceLength)
      ...
      return new DiscardInfo(this, DiscardCode.obvious, "Bounds are preferable over sequence lengths with no shift");
    }
