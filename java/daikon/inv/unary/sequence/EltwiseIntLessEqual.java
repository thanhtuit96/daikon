...
public class EltwiseIntLessEqual extends EltwiseIntComparison {
  ...
  public String format_dsl(@GuardSatisfied EltwiseIntLessEqual this) {

    String dslVariableName = var().name();

    return "expect(" + dslVariableName + ".slice(1).every((element, index) => element >= " + dslVariableName + "[index])).to.be.true";
  }
