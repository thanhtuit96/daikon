...
public class EltwiseIntGreaterEqual extends EltwiseIntComparison {
  ...
  public String format_postman(@GuardSatisfied EltwiseIntGreaterEqual this) {
    ...
    return "pm.expect(" + postmanVariableName + ".every(element => element >= " + postmanVariableName
        + "[0])).to.be.true";
  }

  public String format_dsl(@GuardSatisfied EltwiseIntGreaterEqual this) {
    return "every(" + var().name() + ", element => element >= " + var().name() + "[0])";
  }
