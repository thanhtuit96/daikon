...
public class EltwiseIntGreaterThan extends EltwiseIntComparison {
  ...
  public String format_postman(@GuardSatisfied EltwiseIntGreaterThan this) {
    ...
    return "pm.expect(" + postmanVariableName + ".slice(1).every((element, index) => element < " + postmanVariableName
        + "[index])).to.be.true";
  }
  public String format_dsl(@GuardSatisfied EltwiseIntGreaterThan this) {
    return "every(" + var().name() + ", element, index => index == 0 || element < " + var().name() + "[index-1])";
  }
