...
public class SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm extends SingleStringSequence {
  ...
  public String format_using(@GuardSatisfied SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm this, OutputFormat format) {
    ...
    if (format == OutputFormat.DSL) {
      return "forall(" + var().name() + ", isTimestamp(element, \"YYYY-MM-DDTHH:MM:SS\"))";
    }
  ...
  @Override
  public @Nullable @NonPrototype SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm merge(
      @Prototype SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm this,
      List<@NonPrototype Invariant> invs,
      PptSlice parent_ppt) {
    @SuppressWarnings("nullness") // super.merge does not return null
    @NonNull SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm result = (SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm) super.merge(invs, parent_ppt);
    
    result.alwaysEmpty =
        invs.stream()
            .map(inv -> (SequenceStringElementsAreTimestampYYYYMMHHThhmmssmm) inv)
