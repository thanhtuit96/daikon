...
public final class OneOfStringSequence extends SingleStringSequence implements OneOf {
  ...
  public String format_postman(@GuardSatisfied OneOfStringSequence this) {
    ...
    return "pm.expect(" + specificValues + ".some(value => pm.expect(" + getPostmanVariableName(var().name())
        + ").to.deep.equal(value).that)).to.be.true";
  }
  
  public String format_dsl(@GuardSatisfied OneOfStringSequence this) {
    StringBuilder specificValues = new StringBuilder("[");
