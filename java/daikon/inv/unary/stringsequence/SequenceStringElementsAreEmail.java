...
public class SequenceStringElementsAreEmail extends SingleStringSequence {
  ...
  public String format_using(@GuardSatisfied SequenceStringElementsAreEmail this, OutputFormat format) {
    ...
    if (format == OutputFormat.DSL) {
      return "forall(" + var().name() + ", isEmail(element))";
    }
  ...
  @Override
  public @Nullable @NonPrototype SequenceStringElementsAreEmail merge(
      @Prototype SequenceStringElementsAreEmail this,
      List<@NonPrototype Invariant> invs,
      PptSlice parent_ppt) {

    @SuppressWarnings("nullness")
    @NonPrototype SequenceStringElementsAreEmail result =
        (SequenceStringElementsAreEmail) super.merge(invs, parent_ppt);

    result.alwaysEmpty =
        invs.stream()
            .map(inv -> (SequenceStringElementsAreEmail) inv)
